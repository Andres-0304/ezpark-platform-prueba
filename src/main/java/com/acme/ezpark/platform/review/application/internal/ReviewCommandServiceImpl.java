...
/**
 * Review command service implementation
 * This service handles all review-related commands
 * @author EzPark Team
 */
@Service
public class ReviewCommandServiceImpl implements ReviewCommandService {
    ...
    public Optional<Review> handle(CreateReviewCommand command) {
        try {
            ...
            // Validate that the parking matches
    ...
    public Optional<Review> handle(UpdateReviewCommand command) {
        try {
            ...
            // Validate that the user can update this review
    ...
    public Optional<Review> handle(DeleteReviewCommand command) {
        try {
            ...
            // Validate that the user can delete this review
            if (!review.canBeUpdatedBy(command.userId())) {
                throw new RuntimeException("User is not authorized to delete this review");
            }
            
            // Soft delete (deactivate) the review
            review.deactivate();
